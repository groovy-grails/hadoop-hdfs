...
public class HDFSClient {
	private final String HADOOP_HOME="/usr/local/hadoop";
	private final String CORE_SITE=HADOOP_HOME+"/etc/hadoop/core-site.xml";
	private final String HDFS_SITE=HADOOP_HOME+"/etc/hadoop/hdfs-site.xml";
    public HDFSClient() {
